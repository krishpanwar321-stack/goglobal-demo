        ...
        <div className="mt-16 flex snap-x snap-mandatory gap-6 overflow-x-auto pb-4 scrollbar-hide md:grid md:grid-cols-2 xl:grid-cols-4">
          ...
          {categories.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="group min-w-[320px] shrink-0 snap-center rounded-[30px] border border-zinc-200 bg-zinc-50/70 p-7 transition-all duration-300 hover:-translate-y-1 hover:border-zinc-300 hover:bg-white hover:shadow-xl lg:min-w-0"
              >
