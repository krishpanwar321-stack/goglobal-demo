...
export default function FeaturedOpportunities() {
      ...
      >
        ...
        <div className="animate-pulse">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 h-8 w-full rounded bg-zinc-200" />

            <div className="mt-3 h-8 w-2/3 rounded bg-zinc-200" />
  ...
  : opportunities.map((item) => (
      ...
      <div
        key={item.title}
        className="group relative min-w-[320px] shrink-0 snap-center overflow-hidden rounded-3xl bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl lg:min-w-0"
      >
