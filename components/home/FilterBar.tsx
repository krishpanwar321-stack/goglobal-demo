    ...
    return (
        <section className="border-b border-zinc-200 bg-white px-8 py-3">
         ...
         <div className="flex items-center gap-6">
          ...
          <div
  ref={scrollRef}
  className="flex flex-1 items-center gap-5 overflow-x-auto scroll-smooth scrollbar-hide"
 >
            ...
            {categories.map((item) => {
              ...
              return (
                <button
                  key={item.title}
                  className="group flex min-w-[130px] shrink-0 flex-col items-center gap-2"
                >
          ...
          <button
  onClick={scrollRight}
  className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-zinc-100 transition hover:bg-black hover:text-white"
  >
