    ...
    <>
      ...
      <span className="mt-4 block text-zinc-400">
        ...
        without the noise.
          ...
          <Link
  href="/explore"
  className="rounded-2xl bg-black px-6 py-4 text-center text-sm font-medium text-white transition-all duration-300 hover:scale-[1.02] hover:bg-zinc-800 sm:px-8 sm:text-base"
>
...
<Link
  href="/about"
  className="rounded-2xl border border-zinc-300 bg-white px-6 py-4 text-center text-sm font-medium transition-all duration-300 hover:border-zinc-400 hover:bg-zinc-100 sm:px-8 sm:text-base"
>
