...
export default function OpportunityCard({
...
}: OpportunityCardProps)
 {
  ...
  const handleSave = async () => {
    ...
    return (
      <div className="group h-fit rounded-[32px] border border-[#E7DDD1] bg-[#FFFDF9] p-5 sm:p-7 transition-all duration-300 hover:-translate-y-1 hover:border-black hover:shadow-xl">
...
<div className="-mx-5 -mt-5 mb-6 overflow-hidden rounded-t-[32px] sm:-mx-7 sm:-mt-7">
  ...
  />
        ...
        <div className="flex items-start justify-between">
          ...
          <div>
            ...
            <h2 className="mt-3 text-2xl sm:text-[30px] font-bold leading-tight tracking-tight text-[#2B1D16]">
              {title}
            </h2>
  ...
  <span className="rounded-full border border-[#E7DDD1] bg-[#F8F5F0] px-4 py-2 text-sm font-medium">
    ...
    {mode}
        ...
        <p className="mt-5 text-[15px] leading-7 text-[#6B5B52]">
          {description}
        </p>
