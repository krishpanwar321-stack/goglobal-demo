...
type OpportunityCardProps = {
  ...
  const handleSave = async () => {
    ...
    return (
      <div className="group h-fit rounded-[32px] border border-zinc-200 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-black hover:shadow-xl">
