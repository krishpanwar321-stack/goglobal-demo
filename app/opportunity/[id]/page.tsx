...
<div className="mt-10 flex flex-wrap gap-4">
  ...
  <div className="rounded-2xl border border-zinc-200 bg-white px-5 py-3 text-sm font-medium">
  ...
  {opportunity.applicationLink && (
    ...
    <a
      ...
      target="_blank"
      className="rounded-2xl border border-black px-5 py-3 text-sm font-medium transition hover:bg-black hover:text-white"
    >
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:gap-10">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-[32px] border border-zinc-200 bg-white shadow-sm p-6 sm:p-8 lg:p-10">
...
<button
  ...
  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-black px-5 py-3.5 sm:px-6 sm:py-4 text-sm font-medium text-white transition hover:opacity-90"
>
