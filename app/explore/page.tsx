...
<button
  ...
  className="flex items-center gap-2 rounded-2xl border border-zinc-200 bg-white px-5 py-3 text-sm font-medium shadow-sm"
>
...
<div className="fixed inset-0 z-50 bg-black/40 xl:hidden">
  ...
  <div className="absolute left-0 top-0 h-full w-[85%] max-w-[380px] overflow-y-auto bg-white p-6 shadow-2xl">
...
Reset Filters
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[280px_minmax(0,1fr)] xl:gap-10">
          ...
          <div className="hidden rounded-[28px] border border-zinc-200 bg-white p-5 shadow-sm sm:p-7 xl:block lg:sticky lg:top-28 lg:h-fit lg:rounded-[32px]">
