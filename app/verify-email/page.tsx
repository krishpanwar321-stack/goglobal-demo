...
<div className="absolute left-0 top-0 h-full w-[84px] bg-black" />
  ...
  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-black py-5 text-lg font-medium text-white transition hover:opacity-90"
  >
  ...
  className="w-full rounded-2xl border border-zinc-300 bg-white py-5 text-lg font-medium text-black transition hover:bg-zinc-100"
  >
