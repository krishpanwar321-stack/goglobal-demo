...
useEffect(() => {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f5f5f5]">
        ...
        <div className="hidden lg:block absolute left-0 top-0 h-full w-[84px] bg-black" />
  ...
  <div className="max-w-xl">
    ...
    <div className="mt-10 flex gap-4">
      ...
      <div className="rounded-3xl border border-zinc-200 bg-zinc-50 px-6 py-5">
        ...
        <div className="w-full max-w-md rounded-[28px] border border-zinc-200 bg-white p-6 shadow-sm sm:p-10 sm:rounded-[32px]">
            ...
            <div className="mt-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-black sm:mt-10 sm:h-20 sm:w-20 sm:rounded-3xl">
            ...
            <h1 className="mt-7 text-3xl sm:text-4xl font-bold leading-tight tracking-tight text-black">
            ...
            <div className="mt-8 rounded-2xl border border-zinc-200 bg-zinc-50 px-6 py-5">
              ...
              <p className="mt-1 break-all text-base font-semibold text-black sm:text-lg">
              {email}
              </p>
  ...
  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-black py-4 text-base sm:py-5 sm:text-lg font-medium text-white transition hover:opacity-90"
  >
  ...
  className="w-full rounded-2xl border border-zinc-300 bg-white py-4 text-base sm:py-5 sm:text-lg font-medium text-black transition hover:bg-zinc-100"
  >
