  ...
  return (
    <>
      ...
      <section className="border-b border-zinc-200 bg-white px-5 py-8 sm:px-8 lg:px-10 lg:py-10">
        ...
        <div className="mx-auto mb-8 max-w-5xl rounded-[28px] border border-zinc-200 bg-white p-6 sm:p-8 lg:rounded-[32px]">
...
<div className="mx-auto mt-6 max-w-5xl">
  ...
  <div className="flex flex-wrap gap-3 rounded-[28px] border border-zinc-200 bg-white p-4 shadow-sm sm:p-5">
    ...
    <div className="flex items-center gap-2 rounded-2xl border border-zinc-200 bg-white px-4 py-3 shadow-sm transition hover:border-black hover:shadow-md">
      ...
      <span className="text-sm font-medium text-black">
        Add LinkedIn
          ...
          <div className="mx-auto mt-8 max-w-5xl rounded-[28px] border border-zinc-200 bg-white p-6 sm:p-8 lg:rounded-[32px] lg:p-10">
...
{errors.resume && (
  ...
  className="mt-10 w-full rounded-2xl bg-black px-6 py-4 font-medium text-white transition hover:opacity-90 sm:w-auto"
>
