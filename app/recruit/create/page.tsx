...
<section className="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:px-10 lg:py-16">
  ...
  className="space-y-8 rounded-[32px] border border-zinc-200 bg-white p-6 shadow-sm sm:p-10"
 >
...
/>
    ...
    <div className="border-b border-zinc-100 pb-5 pt-2">
  ...
  <div>
    ...
    <select
      ...
      onChange={(e) =>
        ...
        className="w-full rounded-2xl border border-zinc-300 bg-white px-5 py-4 outline-none transition focus:border-black sm:py-4"
    >
...
<div>
  ...
  className="w-full rounded-2xl border border-zinc-300 px-5 py-4 outline-none transition focus:border-black sm:py-4"
/>
  ...
  <div className="sticky top-24 h-fit rounded-[32px] border border-zinc-200 bg-white p-8 shadow-sm">
